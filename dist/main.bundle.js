...
module.exports = "\n<nav class=\"navbar navbar-light2 navbar-fixed-top\">\n  <div class=\"container-fluid\">\n\n    <!--heading on the nav bar-->\n    <div class=\"navbar-text pull-left\">\n      <a routerLink=\"/profile/{{userId}}/website/{{wid}}/page/{{pid}}/widget\" class=\"black\">\n        <span class=\"glyphicon glyphicon-chevron-left \"></span>\n      </a>\n    </div>\n\n    <div class=\"navbar-brand pull-left\">\n      <div class=\"thick grey\">\n        <b>Widget Edit</b>\n      </div>\n    </div>\n\n    <!--tick mark-->\n    <div class=\"navbar-text pull-right\">\n      <a (click)=\"updateHeader(name, text, size)\"\n          routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page/{{pid}}/widget\" class=\"black\">\n        <span class=\"glyphicon glyphicon-ok \"></span>\n      </a>\n    </div>\n\n  </div>\n</nav>\n\n\n\n<div class=\"container-fluid padding\">\n\n      Name\n      <input [(ngModel)]=\"name\"\n             class=\"form-control\"\n             type=\"text\"\n             placeholder=\"Name\"/>\n\n     Text\n      <input [(ngModel)]=\"text\"\n             class=\"form-control\"\n             type=\"text\"\n             placeholder=\"{{this.widget.text}}\"/>\n\n      Size\n      <input [(ngModel)]=\"size\"\n             class=\"form-control\"\n             type=\"Number\"\n             placeholder=\"{{this.widget.size}}\"/>\n\n\n    <a class=\"btn btn-danger btn-block\"\n       (click)=\"deleteWidget(this.pid, this.wgid)\"\n       routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page/{{pid}}/widget\" >Delete</a>\n\n</div>\n\n\n\n<nav class=\"navbar navbar-light2 navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-text pull-right\">\n      <!--<a href=\"../user/profile.view.client.html\">-->\n      <span class=\"glyphicon glyphicon-user blue\"></span>\n      <!--</a>-->\n    </div>\n  </div>\n</nav>\n\n\n"
...
var WidgetHeaderComponent = (function () {
    // inject route info in constructor
    function WidgetHeaderComponent(userService, websiteService, pageService, route, widgetService) {
        this.userService = userService;
        this.websiteService = websiteService;
        this.pageService = pageService;
        this.route = route;
...
WidgetHeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__services_page_service_client__["a" /* PageService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_page_service_client__["a" /* PageService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6__services_widget_service_client__["a" /* WidgetService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_widget_service_client__["a" /* WidgetService */]) === "function" && _f || Object])
...
module.exports = "\n<nav class=\"navbar navbar-light2 navbar-fixed-top\">\n  <div class=\"container-fluid\">\n\n    <!--heading on the nav bar-->\n    <div class=\"navbar-text pull-left\">\n      <a routerLink=\"/profile/{{userId}}/website/{{wid}}/page/{{pid}}/widget\" class=\"black\">\n        <span class=\"glyphicon glyphicon-chevron-left \"></span>\n      </a>\n    </div>\n\n    <div class=\"navbar-brand pull-left\">\n      <div class=\"thick grey\">\n        <b>Widget Edit</b>\n      </div>\n    </div>\n\n    <!--tick mark-->\n    <div class=\"navbar-text pull-right\">\n      <a (click)=\"updateImage(name, text, url, width)\"\n         routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page/{{pid}}/widget\"  class=\"black\">\n        <span class=\"glyphicon glyphicon-ok\"></span>\n      </a>\n    </div>\n\n  </div>\n</nav>\n\n\n\n<div class=\"container-fluid padding\">\n\n    Name\n    <input [(ngModel)]=\"name\"\n           class=\"form-control\"\n           type=\"text\"\n           placeholder=\"Name\"/>\n\n    Text\n    <input [(ngModel)]=\"text\"\n           class=\"form-control\"\n           type=\"text\"\n           placeholder=\"{{this.widget.text}}\"/>\n\n    URL\n    <input [(ngModel)]=\"url\"\n           class=\"form-control\"\n           type=\"text\"\n           placeholder=\"{{this.widget.url}}\">\n\n    Width\n    <input [(ngModel)]=\"width\"\n           class=\"form-control\"\n           type=\"text\"\n           placeholder=\"{{this.widget.width}}\"/>\n\n\n    Upload\n    <input class=\"form-control\"\n           type=\"file\">\n\n    <div class=\"btn btn-primary btn-block\">Upload Image</div>\n\n    <a class=\"btn btn-danger btn-block\"\n     (click)=\"deleteWidget(this.pid, this.wgid)\"\n     routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page/{{pid}}/widget\" >Delete</a>\n\n</div>\n\n\n\n<nav class=\"navbar navbar-light2 navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-text pull-right\">\n      <!--<a href=\"../user/profile.view.client.html\">-->\n      <span class=\"glyphicon glyphicon-user blue\"></span>\n      <!--</a>-->\n    </div>\n  </div>\n</nav>\n\n"
...
var WidgetImageComponent = (function () {
    // inject route info in constructor
    function WidgetImageComponent(userService, websiteService, pageService, route, widgetService) {
        this.userService = userService;
        this.websiteService = websiteService;
        this.pageService = pageService;
        this.route = route;
...
var WidgetYoutubeComponent = (function () {
    // inject route info in constructor
    function WidgetYoutubeComponent(userService, websiteService, pageService, route, widgetService) {
        this.userService = userService;
        this.websiteService = websiteService;
        this.pageService = pageService;
        this.route = route;
